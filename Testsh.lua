...
local assets = {
	Repentance = LoadCustomInstance("https://raw.githubusercontent.com/Voor-Pr00/Crucifix/refs/heads/main/rrrrrrr.rbxm?raw=true")
}
local moduleScripts = {
...
if tool and tool.Parent == localChar then
	...
	sound:Play()
game.Workspace.RepentanceNEW.Crucifix.Sound.Volume = 0
game.Workspace.RepentanceNEW.Crucifix.Color = Color3.fromRGB(33, 27, 124)
game.Workspace.RepentanceNEW.Crucifix.ExplodeParticle.Brightness = 0.1
...
achievementGiver({
	...
	task.spawn(function()
		...
		if resist == false then
			TweenService:Create(crucifix.Light, TweenInfo.new(1, Enum.EasingStyle.Circular, Enum.EasingDirection.InOut), { Brightness = 1, Range = 1 }):Play()
	...
	if resist == false then
		...
		task.spawn(function()
			...
			color.Value = Color3.fromRGB(33, 27, 124)
...
if game.Players.LocalPlayer.Character:FindFirstChild("Crucifix") then
                    ...
                    v81.Name = "cruxy"
                    v81.Anchored = true
                    v81.Color = Color3.fromRGB(86, 86, 255)
...
CustomGitSound("https://raw.githubusercontent.com/Voor-Pr00/Eye/refs/heads/main/DOORS-UNUSED-SOUNDTRACK-Stress%20(mp3cut.net).mp3", 1, "crucifix")
                    ...
                    require(v83).camShaker:ShakeOnce(200, 5, 0.1, 0.15)
                    local v84 = v82.Functions.LoadCustomInstance("https://github.com/PABMAXICHAC/doors-monsters-models/blob/main/pentafix.rbxm?raw=true")
                    v84.Parent = game.Workspace
                    local v85 = model
                    if typeof(v84) == "Instance" and v84.ClassName == "Model" then
                        ...
                        if true == true then
                            local v88 = next
                            local v89, v90 = v84:GetDescendants()
                            while true do
                                local v91
                                v90, v91 = v88(v89, v90)
                                if v90 == nil then
                                ...
                                if v91.ClassName == "Beam" then
                                    v91.Color = v87
                                end
                            end
                            v84.Circle.Lines.Color = v87
                            v84.Circle.Spark.Color = v87
                        end
                        local v92 = {
                            Position = v86.whitenew.CFrame.Position + Vector3.new(0, 3, 0)
                        }
                        local v93 = {
                            Position = v86.whitenew.CFrame.Position - Vector3.new(0, 18, 0)
                        }
                        local v94 = v80:Create(v86.whitenew, TweenInfo.new(2), v92)
                        local v95 = v80:Create(v84.Entity, TweenInfo.new(2), v92)
                        v94:Play()
                        v95:Play()
                        wait(2)
                        local v96 = next
                        local v97, v98 = v86.whitenew:GetDescendants()
                        while true do
                            local v99
                            v98, v99 = v96(v97, v98)
                            if v98 == nil then
                            ...
                            if v99.ClassName == "Sound" then
                                v80:Create(v99, TweenInfo.new(3), {
                                    Volume = 0
                                }):Play()
                            end
                        end
                        local v100 = v80:Create(v86.whitenew, TweenInfo.new(3), v93)
                        local v101 = v80:Create(v84.Entity, TweenInfo.new(3), v93)
                        v100:Play()
                        v101:Play()
                        wait(4)
                        v86:Destroy()
